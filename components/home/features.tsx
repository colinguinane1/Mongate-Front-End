      ...
      <div className="flex items-center max-w-6xl  mt-20 justify-center flex-col gap-4">
        ...
        <div className="grid grid-cols-1  z-[-1] md:grid-cols-3 gap-6 p-4  ">
          {techStack.map((tech, idx) => (
            <div
              key={idx}
              className="bg-primary/10  relative p-10 h-full flex flex-col gap-4 items-center justify-center rounded-lg shadow-lg shadow-primary/10 border border-primary/30 overflow-hidden"
            >
